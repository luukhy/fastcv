...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m){
    ...
    m.def("connectedComponents", &connectedComponents, "Connected Component Labeling kernel");
    m.def("naiveConnectedComponents", &naiveConnectedComponents, "naive Connected Component Labeling");
}